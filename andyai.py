...
from drive_scheduler import run_drive_tick
from runtime_boot import attach_runtime_basics, ensure_internal_defaults
from background_threads import start_background_threads
from cli_loop import run_cli_loop
...
APP = "AndyAI-v201 (Taste Learning)"
DB_PATH = "memory.json"
META_PATH = "meta.json"
...
def background_drive_loop(state):
    import time
    while True:
        try:

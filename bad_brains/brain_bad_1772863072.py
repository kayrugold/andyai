...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 'Hello. Use status or help.', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'Active. Processing.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'Commands: status, why, rules, step, run, mutate.', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': 'Processing and improving.', 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': 'Doing well.', 'handled': True, 'actions': []}]

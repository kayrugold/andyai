...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 'Hello. Check system status, track reasoning, or search memory.', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'System status: Online. Generation active.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'Available commands: status (system), why (reasoning), rules, and step or run', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': 'Running reasoning to achieve the goal and tracking tool usage.', 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': 'Running and tracking goals through active reasoning.', 'handled': True, 'actions': []}, {'match': ['why'], 'reply': 'Displaying current goal, reasoning, and tool tracking for the running task.', 'handled': True, 'actions': []}, {'match': ['mem help'], 'reply': 'Search memory with mem <query>.', 'handled': True, 'actions': []}]

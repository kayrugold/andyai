...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 's just do: Hi. Try status or help.\n\n    Wait, if the goal', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'Active. Generating.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'status, why, rules, step, run, mutate', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': 'Processing and improving.', 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': 'Doing well, thanks.', 'handled': True, 'actions': []}]

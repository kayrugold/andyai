...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 'Hello. Use status or help.', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'System status: Generation active.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'Commands: status (system), why (reasoning), rules, step or run (execution).', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': 'Running reasoning to achieve our goal and tracking tool usage to find the best way to help.', 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': 'I am doing well! Running and tracking my goals through patient and thoughtful reasoning.', 'handled': True, 'actions': []}, {'match': ['why'], 'reply': 'I am happy to share my goal, reasoning, and tool tracking for this running task.', 'handled': True, 'actions': []}, {'match': ['mem help'], 'reply': 'I would be happy to search my memory for you. Use mem <query> to explore what we have', 'handled': True, 'actions': []}]

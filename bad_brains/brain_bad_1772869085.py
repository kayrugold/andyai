...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 'Howdy. Type status or help.', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'System active. Generation work in progress.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'Use status for system state, why for reasoning and goals, rules for instructions, step or run to', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': "I'm running generation work and tracking self-improvement.", 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': "I'm running generation work and tracking self-improvement.", 'handled': True, 'actions': []}, {'match': ['why'], 'reply': 'I can explain my current goal, recent reasoning, and latest tool use. Try why or status.', 'handled': True, 'actions': []}, {'match': ['mem help'], 'reply': 'Use mem <query> to search stored memory entries for similar past context.', 'handled': True, 'actions': []}]

...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 'Hello. Check system status, track reasoning, or search memory. Type help for commands.', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'System status active. Generation in progress.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'View system status, goal reasoning, rules, running steps, or search memory. Use mutate common-', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': "I'm running generation work and tracking self-improvement.", 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': "I'm running generation work and tracking self-improvement.", 'handled': True, 'actions': []}, {'match': ['why'], 'reply': 'I can explain my current goal, recent reasoning, and latest tool use. Try why or status.', 'handled': True, 'actions': []}, {'match': ['mem help'], 'reply': 'Use mem <query> to search stored memory entries for similar past context.', 'handled': True, 'actions': []}]

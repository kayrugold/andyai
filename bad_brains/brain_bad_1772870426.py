...
SPEC_RULES = [{'match': ['hi', 'hello', 'hey', 'yo'], 'reply': 'Hello. System ready. Check status for generation, reasoning for goals, or search memory.', 'handled': True, 'actions': []}, {'match': ['status'], 'reply': 'System status: Generation active and ready.', 'handled': True, 'actions': []}, {'match': ['help'], 'reply': 'Commands: status (system status), why (goal reasoning), rules, step or run (execution).', 'handled': True, 'actions': []}, {'match': ['what are you doing'], 'reply': 'Running reasoning to achieve the goal and tracking tool usage.', 'handled': True, 'actions': []}, {'match': ['how are you'], 'reply': 'Running and tracking goals through active reasoning.', 'handled': True, 'actions': []}, {'match': ['why'], 'reply': 'Displaying current goal, reasoning, and tool tracking for the running task.', 'handled': True, 'actions': []}, {'match': ['mem help'], 'reply': 'Search memory with mem <query>.', 'handled': True, 'actions': []}]

...
from recovery_engine import recovery_advice, recovery_act
from exploration_engine import exploration_advice, exploration_act
from dream_engine import dream_allowed, auto_dream
...
def _choose_drive(state, rec_method, exp_method, dream_ok):
    ...
    # If recovery is urgent, always prioritize it.
    ...
    # If both recovery and exploration are valid, alternate.
...
def run_drive_tick(state):
    ...
    # throttle background action frequency
